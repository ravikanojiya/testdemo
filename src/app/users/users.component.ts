...
export class UsersComponent implements OnInit {
  ...
  onRowSelect(event) {
    // this.show = false;
    this.messageService.add({severity:'info', summary:'Product Selected', detail: event.data.first_name});
    console.log(event);
...
onRowUnselect(event) {
  // this.show = true;
    ...
    this.messageService.add({severity:'info', summary:'Product Unselected',  detail: event.data.first_name});
    console.log(event);
